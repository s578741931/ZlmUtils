...
public class StatusBarUtil {
    private static final int FAKE_STATUS_BAR_VIEW_ID = 812;
    private static final String TAG_KEY_HAVE_SET_OFFSET = "TAG_KEY_HAVE_SET_OFFSET";
    private static final int FAKE_TRANSLUCENT_VIEW_ID = 19;
    ...
    public static void injectionStatusBar(Activity activity, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
    ...
    public static void setTranslucentForImageView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha, View needOffsetView) {
        ...
        if (needOffsetView != null) {
            Object haveSetOffset = needOffsetView.getTag();
            if (haveSetOffset != null && haveSetOffset instanceof String && ((String) haveSetOffset).equals(TAG_KEY_HAVE_SET_OFFSET)) {
                return;
            }
            ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) needOffsetView.getLayoutParams();
            layoutParams.setMargins(layoutParams.leftMargin, layoutParams.topMargin + getStatusBarHeight(activity),
                    layoutParams.rightMargin, layoutParams.bottomMargin);
            needOffsetView.setTag(TAG_KEY_HAVE_SET_OFFSET);
        }
    }
    ...
    /**
     * view向下偏移一个状态栏的高度（会在当前上外边距的基础上再偏移一个状态栏高度）
     */
    public static void setViewOffsetBy(Activity activity, View needOffsetView) {
        if (needOffsetView != null) {
            Object haveSetOffset = needOffsetView.getTag();
            if (haveSetOffset != null && haveSetOffset instanceof String && ((String) haveSetOffset).equals(TAG_KEY_HAVE_SET_OFFSET)) {
                return;
    ...
    /**
     * view向下偏移一个状态栏的高度（偏移一个状态栏高度，无视原有上边距）
     */
    public static void setViewOffsetTo(Activity activity, View needOffsetView) {
        if (needOffsetView != null) {
            Object haveSetOffset = needOffsetView.getTag();
            if (haveSetOffset != null && haveSetOffset instanceof String && ((String) haveSetOffset).equals(TAG_KEY_HAVE_SET_OFFSET)) {
                return;
